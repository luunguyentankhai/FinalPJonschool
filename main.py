...
from services.calculating import Average_GPA
...
def output_student_list(manager, Slist):
    ...
    print(f"-----------------------------")
    print(f"TOTAL students: {len(Slist)} | Average GPA: {Average_GPA(Slist)}")
    print(f"-----------------------------")
...
def main():
    ...
    while running:
        ...
        match n:
            ...
            case 6:
                manager.classification_gpa(Slist)
            case 7:
                manager.Savefile(Slist)
